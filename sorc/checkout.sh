...
if [[ ! -d fv3gfs.fd ]] ; then
    ...
    git clone --recursive --branch wave-post/production/GFS.v16 https://github.com/MatthewMasarik-NOAA/ufs-weather-model.git fv3gfs.fd >> ${topdir}/checkout-fv3gfs.log 2>&1
    cd ${topdir}
else
